...
struct stru_ofbdep_field ofbdep_field[]={
	{"",'C',0,0,""},
	{"AcctManFee",'N',16,2,"基金账户管理费"},
	{"InstAppSubsAmnt",'N',16,2,"法人追加认购金额"},
	{"InstAppSubsVol",'N',16,2,"法人追加认购份数"},
	...
	{"TotalSubsAmnt",'N',16,2,"申购总金额"},
	{"TotalAccptdSubsVol",'N',10,0,"成功申购总笔数"},
	{"TotalSubsCharge",'N',16,2,"申购手续费总金额"},
	{"TotalSubsVol",'N',16,2,"申购总份数"},
	{"AvailableVol",'N',16,2,"持有人可用基金份数"},
	{"IssueType",'C',1,0,"基金发行方式"},
	{"AmntReinbursed",'N',16,2,"退回金额"},
	{"BackendLoad",'N',16,2,"每笔交易后端收费"},
	{"AcctBalanceInIndividualDistributor",'N',16,2,"持有人在单个销售机构的基金份数"},
	{"TotalVolOfDistributorInTA",'N',16,2,"基金总份数（含冻结）"},
	...
	{"BasisforCalculatingDividend",'N',16,2,"红利/红利再投资基数"},
	...
	{"MinAmountByInst",'N',16,2,"法人首次认购最低金额"},
	{"MinVolByInst",'N',16,2,"法人首次认购最低份数"},
	{"CurrencyType",'A',3,0,"结算币种"},
	{"CustodianCode",'C',3,0,"托管人代码"},
	{"AmountOfPeriodicSubs",'N',16,2,"定时定额申购的金额"},
	{"DateOfPeriodicSubs",'A',8,0,"定时定额申购日期"},
	{"VolOfDividendforReinvestment",'N',16,2,"基金账户红利再投资基金份数"},
	{"DividentDate",'A',8,0,"分红日/发放日"},
	{"DividendAmount",'N',16,2,"基金账户红利资金"},
	{"TotalDividendAmount",'N',16,2,"基金红利总额"},
	{"DividendOrShare",'A',1,0,"红利/红利再投资标志,"},
	{"XRDate",'A',8,0,"除权日"},
	{"DownLoaddate",'A',8,0,"交易数据下传日期"},
	{"EducationLevel",'C',3,0,"投资人学历"},
	{"EmailAddress",'C',40,0,"投资人E-MAIL地址"},
	{"TotalDividendIndeed",'N',16,2,"基金实发红利总金额"},
	{"FaxNo",'C',24,0,"投资人传真号码"},
	{"Charge",'N',10,2,"手续费"},
	{"AgencyFee",'N',10,2,"代理费"},
	{"ChargeRate",'N',6,4,"手续费率"},
	{"TotalTransFee",'N',10,2,"交易确认费用合计"},
	{"TotalFeeForDividend",'N',10,2,"分红费用合计"},
	{"AnnouncementNo",'C',13,0,"公告文件号"},
	{"FreezingDeadline",'A',8,0,"冻结截止日期"},
	{"TotalFrozenVol",'N',16,2,"基金冻结总份数"},
	{"FrozenCause",'A',1,0,"冻结原因"},
	{"FrontendFee",'N',16,2,"每笔交易前端收费"},
	{"ConfirmedVol",'N',16,2,"基金账户交易确认份数"},
	{"FundName",'C',40,0,"基金名称"},
	{"ConfirmedAmount",'N',16,2,"每笔交易确认金额"},
	{"VocationCode",'C',3,0,"投资人职业代码"},
	{"TotalFundVol",'N',16,2,"基金总份数"},
	{"FundCode",'C',6,0,"基金代码"},
	{"FundStatus",'C',1,0,"基金状态"},
	{"HomeTelNo",'C',22,0,"投资人住址电话"},
	{"MaxRedemptionVol",'N',16,2,"基金最高赎回份数"},
	{"MinAccountBalance",'N',16,2,"基金最低持有份数"},
	{"CertificateNo",'C',30,0,"投资人证件号码"},
	{"AnnualIncome",'N',8,0,"投资人年收入"},
	{"AnnouncementDate",'A',8,0,"公告日期"},
	{"AnnouncementType",'A',1,0,"公告类别"},
	{"Interest",'N',10,2,"基金账户利息金额"},
	{"BackAmountByInvalid",'N',16,2,"因为无效而划回投资人的资金"},
	...
	{"OtherFee1",'N',10,2,"其他费用1"},
	{"OtherFee2",'N',16,2,"其他费用2"},
	{"OtherFee3",'N',16,2,"其他费用3"},
	{"TargetDistributorCode",'C',9,0,"对方销售人代码"},
	{"IndividualOrInstitution",'A',1,0,"个人/机构标志"},
	{"IndiAppSubsVol",'N',16,2,"个人追加认购份数"},
	{"IndiAppSubsAmount",'N',16,2,"个人追加认购金额"},
	{"PostCode",'A',6,0,"投资人邮政编码"},
	{"RedemptionDateInAdvance",'A',8,0,"预约赎回日期"},
	{"IPOPrice",'N',7,4,"发行价格"},
	{"MinSubsVolByIndi",'N',16,2,"个人首次认购最低份数"},
	{"MinSubsAmountByIndi",'N',16,2,"个人首次认购最低金额"},
	{"TransactorCertNo",'C',30,0,"经办人证件号码"},
	{"TransactorCertType",'C',1,0,"经办人证件类型,"},
	{"TransactorName",'C',20,0,"经办人姓名"},
	{"TotalRedemptionAmount",'N',16,2,"基金赎回总金额"},
	{"TotalTransactionOfSuccessfulRedemption",'N',10,0,"成功赎回总笔数"},
	{"TotalFeeOfRedemption",'N',16,2,"赎回手续费总金额"},
	{"VolOnRegistraionDate",'N',16,2,"权益登记日基金账户份数"},
	{"RegistrationDate",'A',8,0,"权益登记日期"},
	{"RegistrarCode",'C',2,0,"注册登记人代码"},
	{"RegistrationFee",'N',16,2,"注册登记费"},
	{"TotalReinvestmentDividend",'N',16,2,"红利自动再投资总金额"},
	{"BackAmountByExcess",'N',16,2,"因为剩余而划回投资人的资金"},
	{"TotalRedemptionVol",'N',16,2,"赎回总份数"},
	{"ReturnCode",'A',4,0,"交易处理返回代码"},
	{"TransactionAccountID",'A',17,0,"投资人基金交易账号"},
	{"DistributorCode",'C',9,0,"销售人代码"},
	{"AccountAbbr",'C',12,0,"投资人户名简称"},
	{"DividendRatio",'N',16,2,"红利比例"},
	...
	{"TotalVol",'N',16,2,"基金份数汇总"},
	{"TotalAmount",'N',16,2,"基金金额汇总"},
	{"TargetTAAccountID",'C',12,0,"对方基金账号"},
	{"TrailCommission",'N',16,2,"尾随佣金"},
	{"UpdateDate",'A',8,0,"基金净值日期"},
	{"ValidPeriod",'N',2,0,"交易申请有效天数"},
	{"FaceValue",'N',7,4,"基金面值"},
	{"TargetRegionCode",'A',4,0,"对方所在地区编号"},
	{"TotalFailingVol",'N',16,2,"失败份数汇总"},
	{"TotalSuccessfulVol",'N',16,2,"成功份数汇总"},
	{"DividendPerUnit",'N',16,2,"单位基金分红金额（含税）"},
	{"InterestTax",'N',16,2,"利息税"},
	{"FundVolBalance",'N',16,2,"基金份数余额"},
	{"BeginAllotNo",'N',12,0,"配号开始号"},
	{"EndAllotNo",'N',12,0,"配号结束号"},
	{"TotalAllotNo",'N',12,0,"配号总数"},
	{"CfmVolOfTargetFund",'N',16,2,"目标基金的确认份数"},
	...
	{"TotalFrontendFee",'N',16,2,"交易前端收费总额"},
	{"TotalBackendLoad",'N',16,2,"交易后端收费总额"},
	{"TotalFailingAmount",'N',16,2,"失败金额汇总"},
	{"TotalSuccessfulAmount",'N',16,2,"成功金额汇总"},
	...
	{"UnFrozenBalance",'N',16,2,"解冻红利金额"},
	{"BusinessOrganiger",'C',3,0,"业务发起人代码"},
	{"AccountType",'C',1,0,"账户类型"},
	{"FrozenBalance",'N',16,2,"冻结金额"},
	{"FrozenShares",'N',16,2,"冻结红利再投资份数"},
	{"TotalFare",'N',16,2,"交易费用汇总"},
	...
	{"",'C',0,0,""},
	{"",'C',0,0,""},
	{"MaxSubsVolByIndi",'N',16,2,"个人最高认购份数"},
	{"MaxSubsAmountByIndi",'N',16,2,"个人最高认购金额"},
	{"MaxSubsVolByInst",'N',16,2,"法人最高认购份数"},
	{"MaxSubsAmountByInst",'N',16,2,"法人最高认购金额"},
	{"UnitSubsVolByIndi",'N',16,2,"个人认购份数单位"},
	{"UnitSubsAmountByIndi",'N',16,2,"个人认购金额单位"},
	{"UnitSubsVolByInst",'N',16,2,"法人认购份数单位"},
	{"UnitSubsAmountByInst",'N',16,2,"法人认购金额单位"},
	{"MinBidsAmountByIndi",'N',16,2,"个人首次申购最低金额"},
	{"MinBidsAmountByInst",'N',16,2,"法人首次申购最低金额"},
	{"MinAppBidsAmountByIndi",'N',16,2,"个人追加申购最低金额"},
	{"MinAppBidsAmountByInst",'N',16,2,"法人追加申购最低金额"},
	{"MinRedemptionVol",'N',16,2,"基金最少赎回份数"},
	{"MinInterconvertVol",'N',16,2,"最低基金转换份数"},
	{"IssueTypeByIndi",'C',1,0,"个人发行方式"},
	{"IssueTypeByInst",'C',1,0,"机构发行方式"},
	{"SubsType",'C',1,0,"认购方式"},
	{"CollectFeeType",'C',1,0,"交易费收取方式"},
	{"NextTradeDate",'A',8,0,"下一开放日"},
	{"SalerNetReceivableAmount",'N',16,2,"销售人净收结算金额"},
	{"SalerNetPayableAmount",'N',16,2,"销售人净付结算金额"},
	{"SalerTotalFee",'N',16,2,"销售人收取费用总额"},
	{"SalerBuyFee",'N',16,2,"销售人收取申购费用"},
	{"SalerBidFee",'N',16,2,"销售人收取赎回费用"},
	{"FundTotalFee",'N',16,2,"赎回费用总额（扣除保留在基金资产部分）"},
	{"RaiseTotalAmount",'N',16,2,"认购资金总额"},
	{"AccumulativeTotalRaiseAmount",'N',16,2,"累计认购资金总额"},
	{"RaiseInterest",'N',16,2,"认购期间利息"},
	{"SalerRaiseFee",'N',16,2,"销售人认购费"},
	{"ConversionInAmount",'N',16,2,"转入款"},
	{"ConvertingToAmount",'N',16,2,"转出款"},
	{"SalerExchangeFee",'N',16,2,"销售人转换费"},
	{"BidTax",'N',16,2,"申购印花税"},
	{"RedemptionTax",'N',16,2,"赎回印花税"},
	{"IndividualCapitalGainTax",'N',16,2,"分红个人利得所得税"},
	{"InstituteCapitalGainTax",'N',16,2,"分红机构利得所得税"},
	{"IndividualIncomeTax",'N',16,2,"分红个人增值所得税"},
	{"InstituteIncomeTax",'N',16,2,"分红机构增值所得税"},
	{"SalerReinvestmentFee",'N',16,2,"销售人再投资费"},
	{"SubFeeRetTA",'N',16,2,"申购归注册登记人所得费用"},
	{"RedemFeeRetTA",'N',16,2,"赎回归注册登记人所得费用"},
	{"TotalTransInAmount",'N',16,2,"基金转换入总金额"},
	{"TotalFeeOfTransInAmount",'N',16,2,"基金转换入手续费总金额"},
	{"TotalTransInVol",'N',16,2,"基金转换入总份数"},
	{"TotalTransOutAmount",'N',16,2,"基金转换出总金额"},
	{"TotalFeeOfTransOutAmount",'N',16,2,"基金转换出手续费总金额"},
	{"TotalTransOutVol",'N',16,2,"基金转换出总份数"},
	{"BidTrade",'N',13,0,"成功申购总户数"},
	{"RedeemTrade",'N',13,0,"成功赎回总户数"},
	{"FreezeTotal",'N',16,2,"冻结总份数"},
	{"ManagerCode",'A',3,0,"管理人代码"},
	{"NetBidTotalAmount",'N',16,2,"申购成功资金总额（不含费用，不含税）"},
	{"NetRedeemTotalAmount",'N',16,2,"赎回成功资金总额（不含费用，不含税）"},
	{"CreditDebit",'N',1,0,"借贷方向"},
	{"RedemptionFee",'N',16,2,"赎回费"},
	{"NetSettlement",'N',16,2,"资金清算净额"},
	{"Specification",'C',60,0,"摘要/说明"},
	{"TransferFee",'N',10,2,"过户费"},
	{"FromTAFlag",'A',1,0,"是否注册登记人发起业务标志"},
	{"FrozenMethod",'A',1,0,"冻结方式"},
	{"OriginalAppDate",'A',8,0,"原申请日期"},
	{"TotalBackendLoadVol",'N',16,2,"交易后端收费总份数"},
	...
	{"VolumeByInterest",'N',16,2,"利息产生的基金份数"},
	{"ValueLine",'N',7,2,"产品价值线数值"},
	...
	{"TotalVolumeofReinvestmentDividend",'N',16,2,"红利再投资份额总额"},
	...
	{"XRValue",'N',16,2,"单位除权值"},
	{"XRValueFlag",'C',1,0,"单位除权值正负"},
	{"XRType",'C',1,0,"除权类型"},
	{"DividendType",'C',1,0,"分红类型"},
	{"SequenceNO",'A',20,0,"序号"},
	{"OperateDate",'A',8,0,"生效日期"},
	{"VolLowerLimit",'N',16,2,"份额下限"},
	{"VolUpperLimit",'N',16,2,"份额上限"},
	{"AmountLowerLimit",'N',16,2,"金额下限"},
	{"AmountUpperLimit",'N',16,2,"金额上限"},
	...
	{"RedeemFeeBackRatio",'N',16,2,"赎回费归基金资产比例"},
	{"FundEstablishDate",'A',8,0,"基金成立日期"},
	{"ConstantFee",'N',16,2,"固定费用"},
	{"IsDiscount",'C',1,0,"是否允许打折"},
	{"BuyPayPeriod",'N',16,2,"申购交收天数"},
	{"RedemptionPayPeriod",'N',16,2,"赎回交收天数"},
	{"ConversionPayPeriod",'N',16,2,"基金转换交收天数"},
	{"ChargePayMethod",'C',1,0,"手续费结算方式"},
	{"CompareProportion",'N',16,8,"相对比例"},
	{"CompareCapitalType",'C',3,0,"相对资金类型"},
	{"SubPayBackPeriod",'N',16,2,"认购退款交收天数"},
	{"DividendPayPeriod",'N',16,2,"分红交收天数"},
	{"WholeFlag",'C',1,0,"全量标志"},
	{"ModifyWay",'C',1,0,"修改方式"},
	{"ChangeAgencyFee",'N',16,2,"转换代理费"},
	{"RecuperateAgencyFee",'N',16,2,"补差代理费"},
	{"RedemptionSequence",'C',1,0,"指定赎回方式"},
	{"BuyUpperAmount",'N',16,2,"申购金额上限"},
	{"CovertInUpperAmount",'N',16,2,"基金转换转入金额上限"},
	{"PeriodSubUpperAmount",'N',16,2,"定时定额申购金额上限"},
	{"ChargeType",'C',1,0,"收费类型"},
	{"SpecifyRateFee",'N',9,8,"指定费率"},
	{"SpecifyFee",'N',16,2,"指定费用"},
	...
	{"HandleCharge",'N',10,2,"经手费"},
	{"UndistributeMonetaryIncome",'N',16,2,"货币基金未付收益金额"},
	{"GuaranteedAmount",'N',16,2,"剩余保本金额"},
	...
	{"FundDayIncome",'N',16,2,"基金当日总收益"},
	{"CustomerID",'C',12,0,"客户号"},
	{"RationKind",'C',3,0,"定期定额品种代码"},
	{"BelongFundAssetFare",'N',16,2,"归基金资产费"},
	{"BackFare",'N',16,2,"后收手续费"},
	{"RecuperateFee",'N',16,2,"补差费"},
	{"ChangeFee",'N',16,2,"转换费"},
	{"AchievementPay",'N',16,2,"业绩报酬"},
	{"AchievementCompen",'N',16,2,"业绩补偿"},
	{"",'C',0,0,""},
	{"",'C',0,0,""},
	{"",'C',0,0,""},
	{"",'C',0,0,""},
	{"OverAmount",'N',16,2,"申请超限金额"},
	{"OverShares",'N',16,2,"申请超限份额"},
	{"CapitalGainTax",'N',16,2,"红利所得税"},
	{"CashDividendFee",'N',16,2,"现金分红手续费"},
	...
	{"FrozenSharesforReinvest",'N',16,2,"冻结再投资份额"},
	...
	{"IndiMaxPurchase",'N',16,2,"个人最大申购金额"},
	{"InstMaxPurchase",'N',16,2,"法人最大申购金额"},
	{"IndiDayMaxSumBuy",'N',16,2,"个人当日累计购买最大金额"},
	{"InstDayMaxSumBuy",'N',16,2,"法人当日累计购买最大金额"},
	{"IndiDayMaxSumRedeem",'N',16,2,"个人当日累计赎回最大份额"},
	{"InstDayMaxSumRedeem",'N',16,2,"法人当日累计赎回最大份额"},
	{"IndiMaxRedeem",'N',16,2,"个人最大赎回份额"},
	{"InstMaxRedeem",'N',16,2,"法人最大赎回份额"},
	...
	{"ReservedField4",'N',16,2,"预留字段4"},
	{"ReservedField5",'N',16,2,"预留字段5"},
	{"TAAccountID2",'C',35,0,"投资人基金帐号"},
	{"FundCode2",'C',12,0,"基金代码"},
	{"CodeOfTargetFund2",'C',12,0,"转换时的目标基金代码"},
	{"Charge2",'N',16,2,"手续费"},
	{"AgencyFee2",'N',16,2,"代理费"},
	{"PayAmount",'N',16,2,"交收金额"},
	...
	{"AccumulativePerDiv",'N',16,2,"累积单位分红"},
